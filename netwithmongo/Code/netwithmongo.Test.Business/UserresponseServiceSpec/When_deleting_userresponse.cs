...
{
    public class When_deleting_userresponse : UsingUserresponseServiceSpec
    {
        ...
        public override void Context()
        {
            ...
            _userresponseRepository.Delete(Id).Returns(true);
        }
        ...
        {
            _userresponseRepository.Received(1).Delete(Id);
