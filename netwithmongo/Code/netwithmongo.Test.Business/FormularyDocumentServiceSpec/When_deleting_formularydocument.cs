...
{
    public class When_deleting_formularydocument : UsingFormularyDocumentServiceSpec
    {
        ...
        public override void Context()
        {
            ...
            _formularydocumentRepository.Delete(Id).Returns(true);
        }
        ...
        {
            _formularydocumentRepository.Received(1).Delete(Id);
