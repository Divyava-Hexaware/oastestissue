...
{
    public class When_saving_formularydocument : UsingFormularyDocumentControllerSpec
    {
        ...
        public override void Context()
        {
            ...
            _formularydocumentService.Save(_formularydocument).Returns(_formularydocument);
        ...
        {
            _formularydocumentService.Received(1).Save(_formularydocument);
        ...
        public void Appropriate_result_is_returned()
        {
            ...
            var resultList = (FormularyDocumentDto)resultListObject;
