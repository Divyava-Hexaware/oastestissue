...
{
    public class When_deleting_formularydocument : UsingFormularyDocumentControllerSpec
    {
        ...
        public override void Context()
        {
            ...
            _formularydocumentService.Delete(Id).Returns(true);
        }
        ...
        {
            _formularydocumentService.Received(1).Delete(Id);
