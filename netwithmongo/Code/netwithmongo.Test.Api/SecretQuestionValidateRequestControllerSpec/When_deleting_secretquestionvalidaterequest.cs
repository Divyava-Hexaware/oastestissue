...
{
    public class When_deleting_secretquestionvalidaterequest : UsingSecretQuestionValidateRequestControllerSpec
    {
        ...
        public override void Context()
        {
            ...
            _secretquestionvalidaterequestService.Delete(Id).Returns(true);
        }
        ...
        {
            _secretquestionvalidaterequestService.Received(1).Delete(Id);
