...
{
    public class When_deleting_userresponse : UsingUserresponseControllerSpec
    {
        ...
        public override void Context()
        {
            ...
            _userresponseService.Delete(Id).Returns(true);
        }
        ...
        {
            _userresponseService.Received(1).Delete(Id);
